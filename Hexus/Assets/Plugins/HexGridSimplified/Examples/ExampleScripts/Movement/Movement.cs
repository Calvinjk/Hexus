...
namespace Wunderwunsch.HexGridSimplified
{
    ...
    {
        //[SerializeField]
        //MultiCellDisplay movementBorderDisplay = null;
        [SerializeField]
        ...
        //called by either direct player action or automatically at some point in the turn if it 

        //public void Start() //TODO REMOVE AND REPLACE WITH SOME OTHER INIT METHOD
        //{
        //     //this won't work with saved games but for now it is okay.
        //}
