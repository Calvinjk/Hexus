...
namespace Wunderwunsch.HexGridSimplified
{
    ...
    public static class HexDepreciated
    {
        ...
        private static bool wrapsHorizontal = false;
        public static Vector2Int MapSize { get { return mapSize; } }
        public static bool WrapsHorizontal { get { return wrapsHorizontal; } }

        public static void SetMapAttributes(Vector2Int size, bool horizontalWrap)
        {
        ...
        /// <returns></returns>
        public static T GetValidPositionsSquareMap<T>(T rawPositions) where T : ICollection<Vector3Int>, new()
        {
        ...
        /// <returns></returns>
        public static HashSet<Vector3Int> GetAllWithinManhattanRange(Vector3Int origin, int range, bool includeSelf, bool removeInvalid)
        {
        ...
        /// <param name="removeInvalid"></param>
        /// <returns></returns>
        public static HashSet<Vector3Int> GetRing(Vector3Int origin, int radius, int thickness, bool removeInvalid)
        {
        ...
        /// <param name="removeInvalid"></param>
        /// <returns></returns>
        public static List<Vector3Int> GetLine(Vector3Int origin, Vector3Int target, float offsetFromOriginCenter, int trimStart, int trimEnd, bool removeInvalid) //maybe add option to only return those in mapBounds
        {
            if(WrapsHorizontal)
            {
        ...
        /// <param name="removeInvalid"></param>
        /// <returns></returns>
        public static List<Vector3Int> GetNeighbours(Vector3Int origin, bool removeInvalid)
        {
        ...
        /// <returns></returns>
        public static Vector3Int WrapHorizontal(Vector3Int position, int upperBound)
        {
        ...
        /// <param name="position"></param>
        /// <returns></returns>
        public static Vector3Int ClampToBounds(Vector3Int position)
        {
            Vector2Int offsetCoord = HexConverter.CubeCoordToOffsetCoord(position);            
